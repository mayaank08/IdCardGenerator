  ...
  return (
    <Card className="bg-white shadow-md rounded-lg">
      <CardContent className="p-6">
        <h2 className="text-xl font-display font-semibold mb-4">Student Information</h2>
          ...
          <div className="mb-6">
            ...
            <div className="flex space-x-4">
              <div className="relative">
                ...
                <label
                  htmlFor="template1"
                  className="flex flex-col items-center p-2 text-gray-500 bg-white border border-gray-300 rounded-lg cursor-pointer peer-checked:border-primary-500 peer-checked:text-primary-500 hover:text-gray-600 hover:bg-gray-50"
                >
                  <span className="w-16 h-10 rounded bg-gradient-to-r from-white to-gray-100 border border-gray-200 mb-1"></span>
                  <span className="text-xs">Classic</span>
                </label>
                {selectedTemplate === "template1" && (
                  <i className="ri-check-line absolute top-1 right-1 text-primary-500"></i>
                )}
              </div>
              ...
              <div className="relative">
                ...
                <label
                  ...
                  className="flex flex-col items-center p-2 text-gray-500 bg-white border border-gray-300 rounded-lg cursor-pointer peer-checked:border-primary-500 peer-checked:text-primary-500 hover:text-gray-600 hover:bg-gray-50"
                >
                  <span className="w-16 h-10 rounded bg-gradient-to-r from-primary-500 to-primary-700 mb-1"></span>
